...
const Capabilities = () => {
  const capabilities = [
    ...
    },
    {
      ...
      title: "(בקרוב)יצירת קורס אישי + סילבוס",
      description: "תעלה את כל תכני הקורס שלך והAI שלנו ידע לתת לך מענה בדיוק לפי מה שאתה לומד ולא דברים כלליים מהרשת.",
      features: ["התאמה אישית", "הבנת הקשר", "למידה מתקדמת"]
    },
    {
      icon: <HelpCircle className="w-12 h-12 text-indigo-600" />,
      title: "(בקרוב)יצירת שאלות וחידונים",
    ...
    },
    {
      ...
      title: "(בקרוב)בוט חכם שלומד את הקורס שלך ומלמד אותך",
      description: "בוט AI שיהיה המורה הפרטי שלך לכל מענה",
